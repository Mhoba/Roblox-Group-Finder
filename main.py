...
def groupfinder():
    id = random.randint(1000000, 4000000)
...
#your webhook
hook = input("[-] Enter your webhook url: https://discord.com/api/webhooks/1068433192719228989/FYGAPn-bAy8ORLwapC3VenLh96m1rHKvsbwE0PFt7GU_7EZK6ha36VPDDOGJwS-A6Hpp"))
#number of threads
